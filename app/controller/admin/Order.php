<?php
/**
 * Migrated from main_legacy/controller/app/controller/admin/Order.php
 */
...
class Order extends Controller
{
    ...
    public function refund()
    {
        ...
        admin_log('order_refund', ['id' => $id, 'reason' => $reason]);
        json_success('已标记退款中');
    }
    ...
    public function complaintHandle()
    {
        ...
        admin_log('complaint_handle', ['id' => $id, 'order_id' => $complaint['order_id'], 'result' => $result, 'remark' => $remark]);
        json_success('投诉已处理');
    }
}
