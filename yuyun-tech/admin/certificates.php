...
$items = $site_data['certificates'] ?? [];
$keyPrefix = 'cert_';
$fields = [
    ['key' => 'cert_name', 'label' => '证书名称', 'type' => 'text'],
    ['key' => 'cert_image', 'label' => '图片URL', 'type' => 'text'],
];
?>
<div class="admin-content">
    <div class="admin-card">
        <h2 style="display:flex;align-items:center;justify-content:space-between;">
            <span><i class="fas fa-certificate" style="color:#9b59b6;"></i> 资质证书管理</span>
