...
$items = $site_data['products'] ?? [];
$fields = [
    ['key' => 'product_name', 'label' => '产品名称', 'type' => 'text'],
    ['key' => 'product_desc', 'label' => '产品描述', 'type' => 'textarea'],
    ['key' => 'product_icon', 'label' => '图标(Fa class)', 'type' => 'text', 'default' => 'fa-server'],
    ['key' => 'product_price', 'label' => '价格/起售价', 'type' => 'text', 'default' => '¥99/月起'],
    ['key' => 'product_link', 'label' => '链接', 'type' => 'text', 'default' => 'products.php'],
    ['key' => 'product_color', 'label' => '主题色', 'type' => 'color', 'default' => '#1a73e8'],
];
?>
<div class="admin-content">
    <div class="admin-card">
        <h2 style="display:flex;align-items:center;justify-content:space-between;">
            <span><i class="fas fa-cube" style="color:#1a73e8;"></i> 产品管理</span>
    ...
    <div style="display:none;" id="itemTemplate">
        <div class="item-card">
            <div style="display:flex;align-items:center;gap:12px;margin-bottom:12px;">
                ...
                <span style="color:#4a5568;">新产品</span>
            ...
            <div class="form-group">
                ...
                <?php if ($f['type'] === 'textarea'): ?>
                    <textarea class="form-textarea" name="<?php echo $f['key']; ?>[]" rows="2"><?php echo $f['default'] ?? ''; ?></textarea>
