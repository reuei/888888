...
$adminNav = [
    ...
    ['url' => 'testimonials.php', 'label' => '客户评价', 'icon' => 'fa-star'],
    ['url' => 'messages.php', 'label' => '留言管理', 'icon' => 'fa-envelope'],
    ['url' => 'filemanager.php', 'label' => '文件管理', 'icon' => 'fa-folder-open'],
    ['url' => 'backup.php', 'label' => '备份恢复', 'icon' => 'fa-database'],
    ['url' => 'cache.php', 'label' => '缓存清理', 'icon' => 'fa-broom'],
    ['url' => 'logs.php', 'label' => '操作日志', 'icon' => 'fa-clock-rotate-left'],
    ['url' => 'profile.php', 'label' => '修改密码', 'icon' => 'fa-user-shield'],
];
