...
$items = $site_data['news'] ?? [];
$keyPrefix = 'news_';
$fields = [
    ['key' => 'news_title', 'label' => '标题', 'type' => 'text'],
    ['key' => 'news_date', 'label' => '日期', 'type' => 'text', 'default' => date('Y-m-d')],
    ['key' => 'news_desc', 'label' => '描述', 'type' => 'textarea'],
];
?>
<div class="admin-content">
    <div class="admin-card">
        <h2 style="display:flex;align-items:center;justify-content:space-between;">
            <span><i class="fas fa-newspaper" style="color:#1a73e8;"></i> 新闻动态管理</span>
