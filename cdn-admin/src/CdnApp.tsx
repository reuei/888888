...
const CdnHome = lazy(() => import('./pages/cdn/Home'));
const CdnActivity = lazy(() => import('./pages/cdn/Activity'));
const CdnAgent = lazy(() => import('./pages/cdn/Agent'));
const CdnPricing = lazy(() => import('./pages/cdn/Pricing'));
const CdnContact = lazy(() => import('./pages/cdn/Contact'));
const CdnReport = lazy(() => import('./pages/cdn/Report'));
const CdnFaq = lazy(() => import('./pages/cdn/Faq'));
const CdnDocs = lazy(() => import('./pages/cdn/Docs'));
const CdnLogin = lazy(() => import('./pages/cdn/Login'));
const CdnDashboard = lazy(() => import('./pages/cdn/Dashboard'));
...
function CdnApp() {
  ...
  const handleLogin = (r: Role, remember = true) => {
    if (remember) {
      localStorage.setItem('cdn-role', r);
    } else {
    ...
    <ErrorBoundary>
      <HashRouter>
        <Suspense fallback={<Loading />}>
          <Routes>
            <Route path="/cdn" element={<CdnHome />} />
            <Route path="/cdn/activity" element={<CdnActivity />} />
            <Route path="/cdn/agent" element={<CdnAgent />} />
            <Route path="/cdn/pricing" element={<CdnPricing />} />
            <Route path="/cdn/contact" element={<CdnContact />} />
            <Route path="/cdn/report" element={<CdnReport />} />
            <Route path="/cdn/faq" element={<CdnFaq />} />
            <Route path="/cdn/docs" element={<CdnDocs />} />
            <Route path="/cdn/login" element={<CdnLogin />} />
            <Route path="/cdn/dashboard" element={<CdnDashboard />} />
