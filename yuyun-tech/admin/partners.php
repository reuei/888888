...
$items = $site_data['partners'] ?? [];
$keyPrefix = 'partner_';
$fields = [
    ['key' => 'partner_name', 'label' => '名称', 'type' => 'text'],
    ['key' => 'partner_logo', 'label' => 'Logo图片URL', 'type' => 'text'],
];
?>
<div class="admin-content">
    <div class="admin-card">
        <h2 style="display:flex;align-items:center;justify-content:space-between;">
            <span><i class="fas fa-handshake" style="color:#ff6b35;"></i> 合作伙伴管理</span>
